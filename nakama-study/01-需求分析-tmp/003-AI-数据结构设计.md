...
// BackgroundArchetype 对应 background_archetype 表，描述角色出身配置。
type BackgroundArchetype struct {
	// 出身主键
	...
	Name string `db:"name" json:"name"`
	// 初始属性
	DefaultStrength     int16  `db:"default_strength" json:"default_strength"`
	DefaultAgility      int16  `db:"default_agility" json:"default_agility"`
	DefaultConstitution int16  `db:"default_constitution" json:"default_constitution"`
	DefaultWisdom       int16  `db:"default_wisdom" json:"default_wisdom"`
	StartingCompanion   string `db:"starting_companion" json:"starting_companion"`
...
// TradeGoodCategory / TradeGood / TradeNode / TradeNodeStock 支撑跑商配置。
type TradeGoodCategory struct {
	// 品类主键
...
type TradeGood struct {
	...
	Name string `db:"name" json:"name"`
	// 基准价格（文）
	BasePrice int32 `db:"base_price" json:"base_price"`
	// 稀有度
	Rarity int16 `db:"rarity" json:"rarity"`
	// 基础配额
	BaseQuota int32 `db:"base_quota" json:"base_quota"`
	// 单位件数
	UnitSize int16 `db:"unit_size" json:"unit_size"`
	// 单位重量
	WeightPerUnit int16 `db:"weight_per_unit" json:"weight_per_unit"`
	// 备注
	Notes string `db:"notes" json:"notes"`
}
...
type TradeNode struct {
	...
	// 节点名称
	Name string `db:"name" json:"name"`
	// 节点类型：city/pass/stronghold
	NodeType string `db:"node_type" json:"node_type"`
	// 所属区域或路线段
	Region string `db:"region" json:"region"`
	// 控制势力（可为空）
	FactionID *int32 `db:"faction_id" json:"faction_id,omitempty"`
	// 城市发展度
	DevelopmentLevel int16 `db:"development_level" json:"development_level"`
	// 基础风险百分比
	BaseRisk int16 `db:"base_risk" json:"base_risk"`
	// 节点描述
	Description string `db:"description" json:"description"`
}

type TradeNodeStock struct {
	// 贸易节点ID
	TradeNodeID uuid.UUID `db:"trade_node_id" json:"trade_node_id"`
	// 商品ID
	TradeGoodID int32 `db:"trade_good_id" json:"trade_good_id"`
	// 本地偏好系数
	HomePreference float32 `db:"home_preference" json:"home_preference"`
	// 税率差分
	TaxMarkup float32 `db:"tax_markup" json:"tax_markup"`
	// 节点基础配额
	BaseQuota int32 `db:"base_quota" json:"base_quota"`
	// 稀有度修正
	RarityModifier float32 `db:"rarity_modifier" json:"rarity_modifier"`
}
